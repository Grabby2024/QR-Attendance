    ...
    const handleUserScan = async (scanned) => {
        const handleUserScan = async (scanned) => {
            ...
            try {
                ...
                // ✅ Match user regardless of number/string mismatch
                ...
                // ✅ Use backend-provided PH timestamps directly (no Date parsing)
                ...
                setProcessing(false);
                setTimeout(() => {
                    window.location.href = "https://www.google.com"; // 🔧 replace with your app route later
                }, 1500);
            }
        };
